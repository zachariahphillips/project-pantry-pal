...
**Status:** Phase 0 done (2026-05-27). Phase 1A done (2026-05-28). Phase 1B done (2026-05-29). Phase 1C done (2026-06-01). Phase 2A done (2026-06-03). Phase 2B done (2026-06-04). **Phase 2C done (2026-06-05) — deploy artifacts (Dockerfile, .dockerignore, fly.toml) committed; gunicorn replaces the Flask dev server in prod; SQLite lives on a persistent Fly volume at `/data`. README has the exact `flyctl install → launch → secrets → deploy` runbook. Local prod-shape smoke (gunicorn against absolute-path SQLite) passes all 12 checks; pytest is 62 green.** Phase 3 (AI meal planning) is next.
