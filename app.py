...
Phase 7Y: backup reminder helper for manual PythonAnywhere backups.
Phase 7Z: post-backup download/check reminders.
...
Phase 9A: real-use beta readiness checklist.
